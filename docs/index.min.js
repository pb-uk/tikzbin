(function () {
    ...
    */
    ...
    const getDownloadFileName = (ext) => {
        return (document.getElementById('input-filename').value +
            `.${ext}`);
    };
    const enableDownloadButtons = (enable = true) => {
        var _a, _b, _c, _d;
        if (enable) {
            (_a = document.getElementById('btn-png')) === null || _a === void 0 ? void 0 : _a.removeAttribute('disabled');
            (_b = document.getElementById('btn-svg')) === null || _b === void 0 ? void 0 : _b.removeAttribute('disabled');
            // document.getElementById('btn-jpg')?.removeAttribute('disabled');
            return;
        }
        (_c = document.getElementById('btn-png')) === null || _c === void 0 ? void 0 : _c.setAttribute('disabled', 'disabled');
        (_d = document.getElementById('btn-svg')) === null || _d === void 0 ? void 0 : _d.setAttribute('disabled', 'disabled');
    ...
    window.sourceChanged = () => {
        ...
        (_a = document.getElementById('rendered')) === null || _a === void 0 ? void 0 : _a.replaceChildren(scriptEl);
    ...
    const editor = new EditorView({
        ...
        parent: (_a = document.getElementById('editor')) !== null && _a !== void 0 ? _a : document.body,
    });
    /*
    ...
    */
    const captureSvgAsDataUri = () => {
        const renderedEl = document.getElementById('rendered');
        if (renderedEl == null || renderedEl.firstChild == null)
            return '';
        const svg = renderedEl.firstChild.innerHTML;
        return ('data:image/svg+xml;base64,' +
            window.btoa(svg.replace('<svg', '<?xml version="1.0"?>\n<svg xmlns="http://www.w3.org/2000/svg"')));
    };
    // eslint-disable-next-line
    // @ts-ignore
    window.captureSvg = () => {
    ...
    // eslint-disable-next-line
    // @ts-ignore
    window.capturePng = () => __awaiter(void 0, void 0, void 0, function* () {
